...
class settings_generator(object):
    ...
    def __init__(self,path,manual_settings,version):
        self.path = path
    ...
    def write_file(self):
        ...
        self.file.write('        self.CO2_MFC_factor = '+str(self.output.CO2_MFC_factor)+'\n')
        self.file.write('        self.CO2_MFC_offset = '+str(self.output.CO2_MFC_offset)+'\n')
        self.file.write('        self.CO_MFC_factor = '+str(self.output.CO_MFC_factor)+'\n')
        self.file.write('        self.CO_MFC_offset = '+str(self.output.CO_MFC_offset)+'\n')
        self.file.write('        self.O2_MFC_factor = '+str(self.output.O2_MFC_factor)+'\n')
        self.file.write('        self.O2_MFC_offset = '+str(self.output.O2_MFC_offset)+'\n\n')
